...
export const Footer = () => {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 lg:left-64 bg-dash-white dark:bg-dash-dark border-t border-dash-dark-15 dark:border-dash-white-15 px-4 lg:px-8 h-12 flex items-center z-40">
